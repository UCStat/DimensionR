...
```{r}
#when W is random and other parameters are fixed
set.seed(1000)
...
#b1 = c(-0.0091, -0.0579, -0.1877, 0.4774, 0.4559, -0.6714, -0.1264, -0.0082, 0.0724, -0.2308) %>% as.matrix()
bRW=matrix(c(rep(0, 10)), ncol = 1)
for (i in 1:10) {
  bRW[i, ]= rnorm(1)
}
...
DataRW2=fried(n=N[1],d=10, a=a, b=b, Gamma=Gamma, B_0=b1, e=e2)
DataRW4=fried(n=N[2],d=10, a=a, b=b, Gamma=Gamma, B_0=bRW, e=e4)
DataRW6=fried(n=N[3],d=10, a=a, b=b, Gamma=Gamma, B_0=bRW, e=e6)

write.csv(DataRW2$trainX, file="trainXRW2.csv", row.names = FALSE)
write.csv(DataRW2$trainY, file="trainYRW2.csv", row.names = FALSE)
write.csv(DataRW2$testX, file="testXRW2.csv", row.names = FALSE)
write.csv(DataRW2$testY, file="testYRW2.csv", row.names = FALSE)


write.csv(DataRW4$trainX, file="trainXRW4.csv", row.names = FALSE)
write.csv(DataRW4$trainY, file="trainYRW4.csv", row.names = FALSE)
write.csv(DataRW4$testX, file="testXRW4.csv", row.names = FALSE)
write.csv(DataRW4$testY, file="testYRW4.csv", row.names = FALSE)


write.csv(DataRW6$trainX, file="trainXRW6.csv", row.names = FALSE)
write.csv(DataRW6$trainY, file="trainYRW6.csv", row.names = FALSE)
write.csv(DataRW6$testX, file="testXRW6.csv", row.names = FALSE)
write.csv(DataRW6$testY, file="testYRW6.csv", row.names = FALSE)
```



```{r}
# W is fixed and other parameters are random
set.seed(1000)
...
DataFW2=fried(n=N[1],d=10, a=a, b=b, Gamma=Gamma, B_0=B, e=e2)
DataFW4=fried(n=N[2],d=10, a=a, b=b, Gamma=Gamma, B_0=B, e=e4)
DataFW6=fried(n=N[3],d=10, a=a, b=b, Gamma=Gamma, B_0=B, e=e6)

write.csv(DataFW2$trainX, file="trainXFW2.csv", row.names = FALSE)
write.csv(DataFW2$trainY, file="trainYFW2.csv", row.names = FALSE)
write.csv(DataFW2$testX, file="testXFW2.csv", row.names = FALSE)
write.csv(DataFW2$testY, file="testYFW2.csv", row.names = FALSE)


write.csv(DataFW4$trainX, file="trainXFW4.csv", row.names = FALSE)
write.csv(DataFW4$trainY, file="trainYFW4.csv", row.names = FALSE)
write.csv(DataFW4$testX, file="testXFW4.csv", row.names = FALSE)
write.csv(DataFW4$testY, file="testYFW4.csv", row.names = FALSE)


write.csv(DataFW6$trainX, file="trainXFW6.csv", row.names = FALSE)
write.csv(DataFW6$trainY, file="trainYFW6.csv", row.names = FALSE)
write.csv(DataFW6$testX, file="testXFW6.csv", row.names = FALSE)
write.csv(DataFW6$testY, file="testYFW6.csv", row.names = FALSE)
```
...
```{r}
#when W and other parameters are random
set.seed(1000)
...
DataRRW2=fried(n=N[1],d=10, a=a, b=b, Gamma=Gamma, B_0=bRW, e=e2)
DataRRW4=fried(n=N[2],d=10, a=a, b=b, Gamma=Gamma, B_0=bRW, e=e4)
DataRRW6=fried(n=N[3],d=10, a=a, b=b, Gamma=Gamma, B_0=bRW, e=e6)

write.csv(DataRRW2$trainX, file="trainXRRW2.csv", row.names = FALSE)
write.csv(DataRRW2$trainY, file="trainYRRW2.csv", row.names = FALSE)
write.csv(DataRRW2$testX, file="testXRRW2.csv", row.names = FALSE)
write.csv(DataRRW2$testY, file="testYRRW2.csv", row.names = FALSE)


write.csv(DataRRW4$trainX, file="trainXRRW4.csv", row.names = FALSE)
write.csv(DataRRW4$trainY, file="trainYRRW4.csv", row.names = FALSE)
write.csv(DataRRW4$testX, file="testXRRW4.csv", row.names = FALSE)
write.csv(DataRRW4$testY, file="testYRRW4.csv", row.names = FALSE)


write.csv(DataRRW6$trainX, file="trainXRRW6.csv", row.names = FALSE)
write.csv(DataRRW6$trainY, file="trainYRRW6.csv", row.names = FALSE)
write.csv(DataRRW6$testX, file="testXRRW6.csv", row.names = FALSE)
write.csv(DataRRW6$testY, file="testYRRW6.csv", row.names = FALSE)
...
#gKDR -v
Discrepancy_gv6data = c(Kernel=kernel_method(W=gv1_r, W_0=B),
...
Discrepancy_gv6data= c(Kernel=kernel_method(W=gv2_r, W_0=B),
...
tic <- proc.time()[3]
actr4=DimRed(X=X44 %>% as.matrix() %*% W2[, 1], 
             y=Data4$datatrain[, 11] %>% as.matrix(), 
             XX=Data4$datatest[,-11] %>% as.matrix() %*% W2[, 1], 
             yytrue=Data4$yytrue %>% as.matrix())
toc <- proc.time()[3]
toc - tic

tic <- proc.time()[3]
actr6=DimRed(X=X66 %>% as.matrix() %*% W2[, 1], 
             y=Data6$datatrain[, 11] %>% as.matrix(), 
             XX=Data6$datatest[,-11] %>% as.matrix() %*% W2[, 1], 
             yytrue=Data6$yytrue %>% as.matrix())
toc <- proc.time()[3]
toc - tic
